...
class CapsNet:
    ...
    def build_network(self):
        ...
        with tf.variable_scope('Masking'):
            ...
            self.caps2_output_masked = tf.multiply(tf.squeeze(self.caps2_output), tf.expand_dims(reconst_targets, -1))
            # [batch_size, 10, 16]

            decoder_input = tf.reshape(self.caps2_output_masked, [args.batch_size, -1])
            # [batch_size, 160]
